...
namespace SmartQuant
{
    ...
    //        public bool IsEmpty()
    //        {
    //            return unsyncedQueues.All(q => q.IsEmpty()) && (syncedQueues.Count == 0 || !syncedQueues.All(q => !q.IsEmpty()));
    //        }
    //
    //        public Event Read()
    //        {
    ...
    public class EventPipe
    {
        ...
        public Event Read()
        {
            if (this.linkedList_0.Count != 0)
            {
                ...
                for (; linkedListNode1 != null; linkedListNode1 = linkedListNode1.Next)
                {
                    ...
                    else
                    {
                        ...
                        if ((int)@event.TypeId == EventType.OnQueueClosed)
                        {
            ...
            for (; linkedListNode3 != null; linkedListNode3 = linkedListNode3.Next)
            {
                ...
                if ((int)@event.TypeId != EventType.OnQueueClosed || ((OnQueueClosed)@event).Queue != linkedListNode3.Data)
                {
